...
{field: 'rmReport', headerName: 'RM Report', filter: true, flex: 1.5, cellRendererFramework:(params)=>{
    ...
    return(
        <div>
            ...
            onClick={onRMViewClicked}/> &nbsp;&nbsp;
            <img src={downloadLogo} style={{ height: 30, width: 30 }} onClick={onDownloadClicked} /> 
        </div>
...
{field: 'insuranceReport', headerName: 'Insurance Report', filter: true, flex: 1.5, cellRendererFramework:(params)=>{
    return(
        <div>
            ...
            onClick={onInsuranceViewClicked}/> &nbsp;&nbsp;
            <img src={downloadLogo} style={{ height: 30, width: 30 }} onClick={onDownloadClicked} /> 
        </div>
...
const onViewClicked = (params)=> {
 ...
 const onRMViewClicked = (params)=> {
    console.log('custom params', params.target.getAttribute('data-view'));
    console.log('params collll', params.target.getAttribute('data-col'));
    console.log('parameterrrrrr', parameter);
    //console.log("cell clicked", parameter);
    setOpenPDFModal(true);
 ...
 const onQualityViewClicked = (params)=> {
    console.log('custom params', params.target.getAttribute('data-view'));
    console.log('parameterrrrrr', parameter.data);
    //console.log("cell clicked", parameter);
    setOpenPDFModal(true);

 }

 const onInsuranceViewClicked = (params)=> {
    console.log('custom params', params.target.getAttribute('data-view'));
    console.log('parameterrrrrr', parameter.data);
    //console.log("cell clicked", parameter);
    setOpenPDFModal(true);
